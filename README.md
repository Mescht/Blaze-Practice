...
## Repair Map
If you break something try `/trigger repair` to fix it
...
⚠️ Unfortunately this method is quite resource intensive and **may cause lag** on weaker systems. If you experience lag, try **turning down the resolution setting** or **disabling** this feature.
